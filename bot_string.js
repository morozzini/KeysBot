...
module.exports.err_text_LotteryOverLimitKeys            = "Ошибка лотереи. Слишком много (${0}) ключей для одной лотереи. Максимум ${1}";
...
module.exports.getkey_text_KeyFoundSendChannel          = "Ключ от игр(ы) `${0}` ушел пользователю ${1}.";
...
module.exports.help_text_ShortHelp                      = "help КОМАНДА|Вывести помощь по определенной команде.|addme|Добавить себя в базу данных как автор ключей.|whereme|Вывести сервер и канал к которому ты привязан.|status|Вывести информацию по серверу.|getkey ИНДЕКС|Получить ключ от игры по индексу.|getrandomkey|Получить ключ от случайной игры.|search НАЗВАНИЕ_ИГРЫ|Поиск ключа игры по названию.|show|Показать доступные ключи.|showmy|Показать все доступные ключи которые ты добавил для данного канала.|showkey|Показать все ключи которые ты добавил.|showlot|Показать все лотерейные ключи которые ты добавил.|showlotrun|Показать все запущенные лотереи которые ты добавил.|shownext|Дальнейший вывод соответствующей команды.|showlast|Показать последние добавленные ключи.|addkey НАЗВАНИЕ_ИГРЫ КЛЮЧ|Добваить ключ для игры.|addlot НАЗВАНИЕ_ИГРЫ КЛЮЧ|Добавить лотерейный ключ для игры.|setkey ИНДЕКС|Установить лотерейный ключ как обычный ключ от игры по индексу.|setlot ИНДЕКС|Установить ключ как лотерейный ключ от игры по индексу.|del ИНДЕКС|Удалить любой ключ от игры по индексу.|start ИНДЕКС ВРЕМЯ|Запустить лотерею на определенное время.|stop ИНДЕКС|Остановить запущенную лотерею.|status|Информация о добавленных ключах|about|Информация о боте"
...
module.exports.help_text_Getrandomkey                   = "```Markdown\ngetrandomkey, getrkey, getcat, gc\n> Получить ключ от случайной игры из доступных.```\nДоступные игры можно узнать командой __show__. Работает только в *общем чате*."
module.exports.help_text_Search                         = "```Markdown\nsearch НАЗВАНИЕ_ИГРЫ, find НАЗВАНИЕ_ИГРЫ\n> Найти ключ по названию игры из доступных.```\n**НАЗВАНИЕ ИГРЫ** может быть любым. Можно задать часть имени. Минимальная длина 3 символа, максимальная 10 символов.\nДоступные игры можно узнать командой __show__. Работает только в *общем чате*."
...
module.exports.help_text_Showlast                       = "```Markdown\nshowlast, show last, showend, show end, last, end\n# В общем чате\n> Показать последние добавленные и доступные ключи для данного канала.\n# В личке\n> Показать все ключи для канала, к которому ты привязан.```"
